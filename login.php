...
if(!$_SESSION['pasi'] || $_SESSION['pasi']!= $password ){ 
		...
		if(isset($_POST['pasi'])){ $errMsg = true;
		...
		.errorLogin{ color:#f33; margin:10px; font-size: 17pt; background:rgba(128,128,128, .7); border-radius: 4px; padding:4px 20px;display:inline-block}
